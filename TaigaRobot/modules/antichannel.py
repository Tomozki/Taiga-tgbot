...
from TaigaRobot.modules.helper_funcs.decorators import Taigacmd, Taigamsg
from TaigaRobot.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from TaigaRobot.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel
from TaigaRobot.modules.language import gs

@Taigacmd(command="antichannelmode", group=100)
...
@Taigamsg(Filters.chat_type.groups, group=110)
