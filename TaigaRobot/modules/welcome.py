...
import TaigaRobot.modules.sql.welcome_sql as sql
...
from TaigaRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from TaigaRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from TaigaRobot.modules.helper_funcs.msg_types import get_welcome_type
from TaigaRobot.modules.helper_funcs.handlers import MessageHandlerChecker
from TaigaRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from TaigaRobot.modules.log_channel import loggable
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    f"Nice to have you, Hyoudou Issei-kun Welcome to {html.escape(chat.title)}.", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            if new_mem.id == 5393842751:
                    update.effective_message.reply_photo("https://telegra.ph/file/0f3e8b596000648075557.jpg",
            ...
            if new_mem.id in DRAGONS:
                update.effective_message.reply_text(
                    "Huh! Bishop just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome yourselflog
                ...
                "https://telegra.ph/file/e2b9c59a1439e81c99258.jpg", caption= "Arigato *{}*, I'm *{}!* glad you added me to *{}*\n"
                    "Promote me as admin, to access all my commands.".format(
