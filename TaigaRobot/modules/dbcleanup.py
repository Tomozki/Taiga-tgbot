...
import TaigaRobot.modules.sql.global_bans_sql as gban_sql
import TaigaRobot.modules.sql.users_sql as user_sql
from TaigaRobot import DEV_USERS, OWNER_ID, dispatcher
