...
from TaigaRobot.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from TaigaRobot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from TaigaRobot.modules.sql import disable_sql as sql
