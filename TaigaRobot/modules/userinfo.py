...
from TaigaRobot.__main__ import STATS, TOKEN, USER_INFO
from TaigaRobot.modules.sql import SESSION
import TaigaRobot.modules.sql.userinfo_sql as sql
...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text("<code>Fetching Details..</code>", parse_mode=ParseMode.HTML)
    ...
    if user.id == OWNER_ID:
        text += "\n\nLover of the Heiress of the House of Gremory."
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\nMember of Perverted Trio."
        disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/SenseiUpdates/6"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/SenseiUpdates/7")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + f"\n\n[ Support](https://t.me/senseisupportgroup) | [ Updates](https://t.me/senseiupdates)\n\n",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
        ...
        update.effective_message.reply_text(
            (
                    ...
                    + f"\n\n [Support](https://t.me/senseisupportgroup) | [Anime Chat](https://t.me/senseiupdates)\n\n"
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "Erm... yeah, I only trust the issei to set my bio.",
            )
            return
...
INFO_HANDLER = DisableAbleCommandHandler(["info","profile"], info, run_async=True)
...
__command_list__ = ["setbio", "bio", "setme", "me", "profile", "info"]
__handlers__ = [
    ID_HANDLER,
    GIFID_HANDLER,
    INFO_HANDLER,
