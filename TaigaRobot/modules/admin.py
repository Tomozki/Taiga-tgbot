...
from TaigaRobot import DRAGONS, dispatcher
...
from TaigaRobot.modules.helper_funcs.admin_rights import user_can_changeinfo, user_can_promote
        ...
        reply_markup=InlineKeyboardMarkup([
            [
                InlineKeyboardButton(
                    text="⏬ Demote",
                    callback_data=f"demote_({})".format(user_member.user.id))user_member.user.id},
                ),
            ],
        ], ),
    )
