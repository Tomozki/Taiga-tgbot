from TaigaRobot.modules.disable import (
...
from TaigaRobot import dispatcher as d, LOGGER
...
Taigacmd = SiestaHandler(d).command
Taigamsg = SiestaHandler(d).message
Taigacallback = SiestaHandler(d).callbackquery
Taigainline = SiestaHandler(d).inlinequery
